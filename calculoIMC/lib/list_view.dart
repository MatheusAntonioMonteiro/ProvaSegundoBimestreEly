...
import 'package:calculoIMC/pessoa_screen.dart';
                    ...
                    Divider(height: 5.0),
                      ListTile(
                        ...
                        subtitle: Row(children: [
                          Text('${items[position].nome} ',
                                style: new TextStyle(
                                  fontSize: 18.0,
                                  fontStyle: FontStyle.italic,
                                )
                              ),
                          Text('${items[position].peso} ',
                                style: new TextStyle(
                                  fontSize: 18.0,
                                  fontStyle: FontStyle.italic,
                                )
                              ),
                          Text('${items[position].altura}',
                                style: new TextStyle(
                                  fontSize: 18.0,
                                  fontStyle: FontStyle.italic,
                                )
...
void _createNewPessoa(BuildContext context) async {
    ...
    String result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PessoaScreen(Pessoa('', 0, 0, 0))),
    );
